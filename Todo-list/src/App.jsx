...
export default function App() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <aside className="w-64 bg-[#0f1f4a] text-white flex flex-col">
          ...
          <ul className="space-y-3">
            <li
              ...
              className={`px-4 py-2 rounded-lg cursor-pointer transition ${
                filter === "All" ? "bg-blue-600" : "hover:bg-blue-800"
              }`}
            >
            ...
            <li
              ...
              className={`px-4 py-2 rounded-lg cursor-pointer transition ${
                filter === "Todo" ? "bg-blue-600" : "hover:bg-blue-800"
              }`}
            >
            ...
            <li
              ...
              className={`px-4 py-2 rounded-lg cursor-pointer transition ${
                filter === "In Progress" ? "bg-blue-600" : "hover:bg-blue-800"
              }`}
            >
              In Progress (
            ...
            <li
              ...
              className={`px-4 py-2 rounded-lg cursor-pointer transition ${
                filter === "Completed" ? "bg-blue-600" : "hover:bg-blue-800"
              }`}
            >
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex gap-3">
            <input
              ...
              className="px-4 py-2 border rounded-lg w-72 outline-none focus:ring-2 focus:ring-blue-500"
            />
